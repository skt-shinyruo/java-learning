...
1. 本文，先把 JMM 的主线建立起来
2. [`volatile-jmm.md`](./volatile-jmm.md)，把发布/可见性/反例吃透
3. [`cas-notes.md`](./cas-notes.md)，把原子类、CAS 自旋、HotSpot/CPU 实现链路补齐
4. [`synchronized-notes.md`](./synchronized-notes.md)，把 monitor、字节码、锁语义补齐
5. [`wait-notify.md`](./wait-notify.md)，把条件等待和 monitor 协作补齐
6. [`lock-support.md`](./lock-support.md)，把 `park/unpark`、permit 和 AQS 底层阻塞原语补齐
7. [`references/jmm/jsr-133-faq.md`](./references/jmm/jsr-133-faq.md)，再回到 JSR-133 FAQ 看官方口径
